...
if __name__ == "__main__":
    ...
    # density of states
    dosrun = Vasprun("cl_vasprun.xml")
    spd_dos = dosrun.complete_dos.get_spd_dos()

    # bands
    run = Vasprun("cl_vasprun.xml", parse_projected_eigen=True)
    ...
    font = {'family': 'serif', 'size': 24, 'fontname': 'Times New Roman'}
    #plt.rc('font', **font)
    ...
    #fig.suptitle(r"Band structure of $K_2CuCl_3$")
    ...
    ax1.set_xlim(0, len(bands.kpoints)-1)
    ...
    ax2.set_xticklabels([])
    ax2.hlines(y=0, xmin=0, xmax=20, color="k", lw=2)
